...
RSpec.describe GamePlayersController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all game_players as @game_players" do
      game_player = GamePlayer.create! valid_attributes
  ...
  describe "GET edit" do
    it "assigns the requested game_player as @game_player" do
      game_player = GamePlayer.create! valid_attributes
      get :edit, {:id => game_player.to_param}, valid_session
      expect(assigns(:game_player)).to eq(game_player)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved game_player as @game_player" do
        post :create, {:game_player => invalid_attributes}, valid_session
        expect(assigns(:game_player)).to be_a_new(GamePlayer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested game_player" do
        game_player = GamePlayer.create! valid_attributes
        put :update, {:id => game_player.to_param, :game_player => new_attributes}, valid_session
        game_player.reload
      ...
      it "assigns the requested game_player as @game_player" do
        game_player = GamePlayer.create! valid_attributes
        put :update, {:id => game_player.to_param, :game_player => valid_attributes}, valid_session
        expect(assigns(:game_player)).to eq(game_player)
      end

      it "redirects to the game_player" do
        game_player = GamePlayer.create! valid_attributes
        put :update, {:id => game_player.to_param, :game_player => valid_attributes}, valid_session
        expect(response).to redirect_to(game_player)
      end
    end

    describe "with invalid params" do
      it "assigns the game_player as @game_player" do
        game_player = GamePlayer.create! valid_attributes
        put :update, {:id => game_player.to_param, :game_player => invalid_attributes}, valid_session
        expect(assigns(:game_player)).to eq(game_player)
      end
