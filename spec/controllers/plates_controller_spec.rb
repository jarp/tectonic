  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved plate as @plate" do
        post :create, {:plate => invalid_attributes}, valid_session
        expect(assigns(:plate)).to be_a_new(Plate)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested plate" do
        plate = Plate.create! valid_attributes
        put :update, {:id => plate.to_param, :plate => new_attributes}, valid_session
        plate.reload
    ...
    describe "with invalid params" do
      it "assigns the plate as @plate" do
        plate = Plate.create! valid_attributes
        put :update, {:id => plate.to_param, :plate => invalid_attributes}, valid_session
        expect(assigns(:plate)).to eq(plate)
      end
